class AgentGroup:
    ...
    def __init__(self, agents, path, current_node, algorithm, knowledge_level, *, blocked_nodes=None):
        """
        ...
        Parameters:
            ...
            current_node (str): The current node identifier.
            algorithm (int): The algorithm identifier (e.g., 0 for shortest path, 1 for centrality measures).
        ...
        self.path = path                              # The designated path for the group.
        self.current_node = current_node              # Current node identifier.
